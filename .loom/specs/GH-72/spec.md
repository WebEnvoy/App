...
Upgrade the App repository Loom workflow pin from 0.21.1 to 0.22.1.
...
- PR metadata binds to GitHub Work Item GH-72, not INIT-0001.
...
- Recheck condition: Require a fresh review and stronger validation if this PR changes workflow command structure, product files, runtime behavior, schemas, APIs, fixtures, generated facts, or any non-GH-72 Loom carrier.
