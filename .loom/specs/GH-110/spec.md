...
- contracts.md not_applicable rationale: GH-110 consumes fixture-shaped Core/Lode/Harbor projections and does not change owner API contracts; consumer boundary: do not treat fixture field names as owner schema truth; recheck condition: require contracts.md before wiring live Core/Harbor/Lode fields.
- readiness-checklist.md not_applicable rationale: GH-110 is a bounded #95 batch with explicit acceptance checks; consumer boundary: readiness is limited to local evidence/source/session reference UI and smoke, not Stage 5; recheck condition: require readiness-checklist.md if the PR claims Library lifecycle, full Browser management, or milestone-adjacent scope beyond #95.
- research.md not_applicable rationale: GH-110 consumes accepted ADR 0008, DESIGN.md, VISION.md, and GitHub issue bodies; no new product research decision is made; consumer boundary: fixture examples are not research conclusions; recheck condition: require research.md for new product direction or owner contract interpretation.
- suite-index.md not_applicable rationale: the minimal suite is located by `.loom/specs/GH-110/spec.md`, `.loom/specs/GH-110/plan.md`, `.loom/specs/GH-110/implementation-contract.md`, `.loom/specs/GH-110/task-carrier.md`, and future `.loom/specs/GH-110/build-evidence.json`; consumer boundary: this omission applies only to the minimal GH-110 batch; recheck condition: require suite-index.md if additional full-suite artifacts or cross-item suite navigation are introduced.
