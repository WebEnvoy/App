...
| EV-002 | test_evidence | scripts/smoke.mjs | EV-001 | Typecheck, mock POST /tasks contract smoke, packaged readonly smoke, and diff check | present | Local contract smoke against Core-main query-only parser shape; no live account/site action | Rerun after App code, Core #227 parser, runtime, or test changes. |
