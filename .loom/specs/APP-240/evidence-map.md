...
| EV-002 | test_evidence | scripts/smoke.mjs | EV-001 | Typecheck, exact BOSS mock POST /tasks contract smoke including target_type rejection, packaged readonly smoke, and diff check | present | Local contract smoke bound to Core PR #273 head 09203469; no live account/site action | Rerun after App code, Core #273 head/merge, runtime, or test changes. |
