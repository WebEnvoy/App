...
4. Validate complete Harbor runtime session facts, require only the exact HTTP 404 Harbor unavailable owner body (`session_missing` or `session_lost`) before recovery, and share concurrent recovery attempts.
