...
- Next Step: Consume hosted `loom-pr-merge-gate`, then perform controlled merge only if checks pass. Keep App #265 open after merge: the next blocker is a missing ready/logged-in Harbor live identity for Xiaohongshu/BOSS, not runtime health or provider detection.
