...
- Latest Validation Summary: 2026-07-11T16:17Z: `npm run typecheck`, `npm run smoke`, `npm run smoke:packaged:readonly`, and `git diff --check` passed. Smoke proves the structured BOSS search payload and fail-closed negatives without real account/site actions; packaged readonly proves fixture identity remains blocked.
