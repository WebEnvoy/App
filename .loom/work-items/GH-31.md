...
- Workspace Entry: `/Volumes/2T/dev/WebEnvoy/.worktrees/App-31-loom-pr-closeout-rules`
...
- `AGENTS.md`
- `.loom/work-items/GH-31.md`
- `.loom/progress/GH-31.md`
- `.loom/specs/GH-31/spec.md`
- `.loom/specs/GH-31/plan.md`
- `.loom/specs/GH-31/implementation-contract.md`
- `.loom/reviews/GH-31.spec.json`
- `.loom/reviews/GH-31.json`
