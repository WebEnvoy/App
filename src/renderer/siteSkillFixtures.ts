...
export const siteSkillFixtures: SiteSkill[] = [
  {
    ...
    sourceHealth: { label: "source ready", status: "ready", detail: "Core owner API 可回读小红书 capability-runs；离线时显示 fallback projection。" },
    tags: ["小红书", "搜索", "笔记读取", "只读"],
    inputTemplates: ["搜索词", "笔记 URL/ID", "小红书身份环境"],
    readiness: [
      { label: "Lode metadata", status: "ready", detail: "小红书 search-notes/read-note-detail capability refs 已锁定" },
      { label: "Harbor identity", status: "ready", detail: "小红书运营号 A fixture" },
      { label: "Core run", status: "ready", detail: "优先读取 Core /capability-runs、/runs/:id/result 和 evidence refs" },
    ],
    boundaries: [
  ...
  },
  {
    ...
    readiness: [
      { label: "Lode metadata", status: "ready", detail: "BOSS job-search/read-job-detail capability refs 已锁定" },
  ...
  },
  {
    ...
    sourceHealth: { label: "write-pre fixture", status: "ready", detail: "Core、Harbor、Lode fixture 可投影小红书发布草稿写前验证。" },
    tags: ["小红书", "写前验证", "草稿", "未发布"],
    inputTemplates: ["草稿标题", "正文素材", "话题", "小红书身份环境"],
    readiness: [
      { label: "Lode expected_change", status: "ready", detail: "发布草稿写前能力 metadata fixture available" },
      { label: "Harbor composer refs", status: "ready", detail: "小红书发布器字段 ref 和截图 ref 可投影" },
  ...
  },
  {
    ...
    readiness: [
      { label: "Lode expected_change", status: "ready", detail: "打招呼写前能力 metadata fixture available" },
